...
try:
    ...
    print(f"InPaint Function CAN NOT BE Imported!!! Error: {e}")
...
class MeshRender:
    ...
    def uv_inpaint(self, texture, mask, vertex_inpaint=True, method="NS", return_float=False):
        ...
        if vertex_inpaint:
            if not MESH_INPAINT_AVAILABLE or meshVerticeInpaint is None:
                raise RuntimeError("meshVerticeInpaint is required for vertex_inpaint but is not available. Please compile mesh_inpaint_processor extension.")
